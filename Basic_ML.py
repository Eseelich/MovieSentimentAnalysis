...
sample = pd.read_excel(r'C:\Users\soras\Downloads\sample_labeled.xlsx')
...
df_full = pd.read_csv(r'C:\Users\soras\Downloads\Pirates 2 .csv')
X_full_tfidf = tfidf.transform(df_full['comment_body'])
df_full['sentiment'] = clf.predict(X_full_tfidf)
df_full.to_csv(r'C:\Users\soras\Downloads\Pirates_with_sentiment_final.csv', index=False)

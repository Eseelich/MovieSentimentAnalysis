...
if __name__ == '__main__':
    ...
    sns.scatterplot(x=test_df['label'], y=preds_final, alpha=0.4)
    ...
    wrong = test_df[preds_final != test_df['label']]
    text = " ".join(wrong['cleaned_body'].dropna())
    wc = WordCloud(width=800, height=400, background_color="white").generate(text)
    plt.imshow(wc, interpolation='bilinear')
    plt.axis("off")
    plt.title("Words in Misclassified Samples")
    plt.savefig("wordcloud_misclassified.png")
